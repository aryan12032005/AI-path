  ...
  <footer className="bg-secondary/40 border-t border-border/60 pt-16 pb-8">
    <div className="section-container pb-12 grid grid-cols-1 md:grid-cols-4 gap-10">
      <div className="md:col-span-2">
        ...
        <p className="text-muted-foreground max-w-sm leading-relaxed mb-6">
          Empowering professionals and students worldwide to navigate their careers with precision and confidence using AI.
        </p>
        <div className="flex items-center gap-4">
          <a href="#" className="w-10 h-10 rounded-full bg-background border border-border flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary hover:shadow-md transition-all">
            <Twitter size={18} />
          </a>
          <a href="#" className="w-10 h-10 rounded-full bg-background border border-border flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary hover:shadow-md transition-all">
            <Linkedin size={18} />
          </a>
          <a href="#" className="w-10 h-10 rounded-full bg-background border border-border flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-foreground hover:shadow-md transition-all">
            <Github size={18} />
          </a>
        </div>
      </div>
    ...
    <div className="section-container border-t border-border/50 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-2 text-sm text-muted-foreground">
        Made with <span className="text-red-500 animate-pulse">❤</span> by the Team
      </div>
    </div>
  </footer>
);
