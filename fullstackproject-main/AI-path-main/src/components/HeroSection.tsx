      ...
      <div className="max-w-5xl mx-auto text-center relative">
        ...
        >
          ...
          <span className="relative inline-block mt-2">
            ...
            <span className="relative text-transparent bg-clip-text bg-gradient-to-r from-primary via-secondary to-accent">Future Path</span>
          </span>
        </motion.h1>
        ...
        >
          ...
          AI-driven roadmap that adapts in real-time to build your ultimate career.
        </motion.p>
        ...
        >
          ...
          >
            ...
            <div className="relative flex items-center justify-center gap-2 bg-white/90 backdrop-blur-md border border-primary/20 text-foreground font-bold px-8 py-4 rounded-xl hover:bg-white transition-all duration-300 text-lg shadow-xl shadow-primary/10">
              Initialize Sequence
              <ArrowRight size={20} className="group-hover:translate-x-2 group-hover:text-primary transition-all duration-300" />
            </div>
          </Link>
          ...
          >
            <Globe className="text-muted-foreground group-hover:text-secondary transition-colors" size={20} />
        ...
        >
          {[
            { value: "100K+", label: "Neural Connections", suffix: "active paths" },
            ...
            >
              ...
              <p className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-br from-foreground to-foreground/50">{stat.value}</p>
              <p className="text-secondary font-bold text-sm mt-2 tracking-widest uppercase">{stat.label}</p>
              <p className="text-xs text-muted-foreground/70 font-mono mt-1">{stat.suffix}</p>
            </motion.div>
          ))}
        </motion.div>
      </div>
