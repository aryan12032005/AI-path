...
const steps = [
  {
    ...
    description: "Securely synchronize your core skills, historical experience, and ultimate operational goals.",
  ...
  },
  {
    ...
    description: "Our intelligence engine cross-references your profile against billions of real-time market data points.",
  ...
  },
  {
    ...
    description: "Deploy a hyper-personalized, adaptive skill-acquisition roadmap plotted to your precise success vector.",
...
const HowItWorksSection = () => (
  <section id="how-it-works" className="section-padding bg-slate-50 relative border-y border-foreground/5 overflow-hidden">
    ...
    <div className="section-container relative z-10">
      <div className="text-center max-w-4xl mx-auto mb-24">
        ...
        >
          <span className="text-xs font-bold tracking-widest text-accent uppercase">Initialization Sequence</span>
        </motion.div>
        ...
        >
          Protocol <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-secondary to-accent">Activation</span>
        </motion.h2>
        <motion.p 
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
      ...
      <div className="relative mt-24">
        ...
        >
          {steps.map((s, i) => (
            <motion.div variants={item} key={s.step} className="flex flex-col items-center text-center group">
              <div className="relative mb-10">
                ...
                <div className={`w-28 h-28 rounded-2xl bg-gradient-to-br ${s.color} flex items-center justify-center text-white shadow-[0_10px_30px_rgba(0,0,0,0.1)] group-hover:shadow-[0_15px_40px_rgba(0,0,0,0.15)] relative z-10 transition-all duration-500 group-hover:-translate-y-4 group-hover:scale-110 before:absolute before:inset-[2px] before:bg-white before:rounded-[14px]`}>
                  <s.icon size={44} className="relative z-10 text-primary drop-shadow-sm group-hover:text-secondary transition-colors duration-500" />
                  <div className={`absolute inset-0 rounded-2xl bg-gradient-to-br ${s.color} opacity-10 relative z-0`} />
                </div>
              ...
              <h3 className="text-3xl font-black mb-4 text-foreground group-hover:text-primary transition-colors duration-300">{s.title}</h3>
              <p className="text-muted-foreground leading-relaxed max-w-sm font-medium text-lg mx-auto">{s.description}</p>
            </motion.div>
          ))}
        </motion.div>
      </div>
