import { Brain, BarChart3, Map, Activity, ShieldAlert, Cpu } from "lucide-react";
...
const features = [
  {
    ...
    description: "Adaptive learning algorithms mapping your optimal skill acquisition trajectory.",
  },
  {
    icon: BarChart3,
    title: "Predictive Analytics",
    description: "Real-time market data computing your highest-probability career success vectors.",
  },
  {
    icon: Map,
    title: "Dynamic Topography",
    description: "Your curriculum shifts instantaneously as you acquire new cognitive milestones.",
  },
  {
    icon: Activity,
    title: "Telemetry Sync",
    description: "Continuous monitoring of your bio-progress with granular performance metrics.",
  },
  {
    icon: ShieldAlert,
    title: "Vulnerability Scan",
    description: "Immediate detection of skill gaps with auto-generated mitigation protocols.",
  },
  {
    icon: Cpu,
    title: "Core Processing",
    description: "Deep-learning models processing millions of career outcomes to guide your choices.",
  },
];
  ...
  <section id="features" className="section-padding bg-background relative overflow-hidden">
    ...
    <div className="section-container text-center relative z-10">
      ...
      >
        ...
        <span className="text-xs font-bold tracking-widest text-secondary uppercase">System Architecture</span>
      </motion.div>
      ...
      >
        Next-Gen <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-secondary to-accent">Capabilities</span>
      </motion.h2>
      ...
      >
        Constructed with advanced neural networks, our system processes infinite variables to optimize your learning velocity.
      </motion.p>
      ...
      >
        {features.map((f, i) => (
          ...
          >
            ...
            <h3 className="font-extrabold text-2xl text-foreground relative z-10 group-hover:text-primary transition-colors">{f.title}</h3>
            <p className="mt-4 text-base text-muted-foreground leading-relaxed font-medium relative z-10 group-hover:text-foreground transition-colors duration-300">{f.description}</p>
          </motion.div>
        ))}
      </motion.div>
    </div>
