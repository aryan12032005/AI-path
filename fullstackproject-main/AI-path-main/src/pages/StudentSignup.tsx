      ...
      >
        <Card className="w-full shadow-lg border-primary/10">
          <CardHeader className="text-center space-y-2">
            ...
            <CardDescription>Enter your details below to start your AI-powered learning journey.</CardDescription>
          </CardHeader>
        <CardContent>
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <Button type="submit" className="w-full transition-transform active:scale-95 shadow-md group">
              Sign Up
        ...
        <CardFooter className="flex flex-col space-y-4 text-center text-sm text-muted-foreground pb-6">
          <div>
            ...
            <Link to="/student-login" className="font-medium text-primary hover:underline hover:text-primary/80 transition-colors">
              Log in
            </Link>
          </div>
        </CardFooter>
